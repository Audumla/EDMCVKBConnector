...
This repository is the EDMC plugin, not the agent runner.

- If `AGENT.md` exists, treat it as the source of truth for any external runner
  integration in this workspace.
- Do not rely on in-repo runner code or recreate `agent_system/` here.
- Keep machine-local artifacts outside tracked project files.
- Work primarily in `src/edmcruleengine/`, `load.py`, `docs/`, `scripts/`, and
  `test/`.
- Finish with explicit validation of the affected plugin behavior and tests.
