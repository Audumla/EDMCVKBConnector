...
Complete reference for the signal-based rule schema.

## Overview

Rules use high-level **signals** defined in `signals_catalog.json`:
...
See `rules_.json.example` for complete working examples including:
